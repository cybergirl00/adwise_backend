...
import {  createMedia, generateAIScript, getMatchingCampaigns, getUserMedia, getUserMediagallery, handleClick, verifyApiKey } from "../controller/ad.controller.js";
...
adRouter.get('/getgallery/:ownerId', getUserMediagallery)
